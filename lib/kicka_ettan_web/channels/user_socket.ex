defmodule KickaEttanWeb.UserSocket do
  use Phoenix.Socket
  ...
  ## Channels
  channel "game:*", KickaEttanWeb.GameChannel
  ...
  def connect(params, socket, _connect_info) do
    ...
    # Later, we might want to validate player_id
  ...
  #
  #     Elixir.KickaEttanWeb.Endpoint.broadcast("user_socket:#{user.id}", "disconnect", %{})
  #
