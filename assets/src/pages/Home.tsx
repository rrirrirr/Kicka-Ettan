...
import { Play, History, ChevronDown, ChevronUp, Info, Settings, Repeat, BookOpen } from 'lucide-react';
                    ...
                    <div className="space-y-5 px-2">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="bg-white/50 p-4 rounded-xl border border-gray-100">
                                ...
                                <p className="text-sm text-gray-600 leading-relaxed">
                                    Radius: 120px — The nuclear option. Blocks huge portions of the house.
                                </p>
                            </div>
                        </div>
